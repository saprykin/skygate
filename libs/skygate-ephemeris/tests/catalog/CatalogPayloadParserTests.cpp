...
void CatalogPayloadParserTests::parsesOpenNgcPayload()
{
    constexpr std::string_view kOpenNgcCsv =
        ...
        "NGC0224;G;00:42:44.35;+41:16:08.6;And;177.83;69.66;35;4.36;3.44;;;;13.35;SA(s)b;;;;31;0224;;;PGC 2557,UGC "
...
void CatalogPayloadParserTests::parsesHygZipPayload()
{
    ...
    const std::string_view zippedData(reinterpret_cast<const char*>(kZippedCsv.data()), kZippedCsv.size());
...
void CatalogPayloadParserTests::rejectsInvalidArchivePayloads()
{
    ...
    const std::string_view invalidGzipData(reinterpret_cast<const char*>(invalidGzip.data()), invalidGzip.size());
    ...
    const std::string_view emptyZipData(reinterpret_cast<const char*>(kEmptyZip.data()), kEmptyZip.size());
    QTest::ignoreMessage(
...
void CatalogPayloadParserTests::logsSampledInvalidOpenNgcRows()
{
    constexpr std::string_view kOpenNgcCsv =
        ...
        "NGC0224;G;00:42:44.35;+41:16:08.6;And;177.83;69.66;35;4.36;3.44;;;;13.35;SA(s)b;;;;31;0224;;;PGC "
        "2557;Andromeda Galaxy;;\n";
