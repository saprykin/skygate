...
void CatalogArchiveInflaterTests::inflaterRejectsInvalidInputsAndHonorsOptions()
{
    ...
    constexpr std::array<unsigned char, 17> kRawDeflate{
        0x4b, 0xcc, 0x29, 0xc8, 0x48, 0xd4, 0x49, 0x4a, 0x2d, 0x49, 0xe4, 0x32, 0xd4, 0x31, 0xe2, 0x02, 0x00
    };
    const std::string_view rawDeflate(reinterpret_cast<const char*>(kRawDeflate.data()), kRawDeflate.size());
