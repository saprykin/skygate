...
[[nodiscard]] std::optional<Matrix3x3> precessionNutationMatrix06A(const AstronomicalEpoch& terrestrialTime) noexcept;
[[nodiscard]] std::optional<double> earthRotationAngle00(const AstronomicalEpoch& universalTime1) noexcept;
[[nodiscard]] std::optional<double> tioLocatorS00(const AstronomicalEpoch& terrestrialTime) noexcept;
[[nodiscard]] std::optional<Matrix3x3>
