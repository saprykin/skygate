...
constexpr std::array<BundledDeepSkyObjectEntry, 110> kBundledMessierEntries{{
    ...
    {"messier_002",
     "M2",
     DeepSkyObjectKind::GlobularCluster,
     21.55750278,
     -0.82330556,
     6.250,
     8.4,
    ...
    {"messier_027",
     "M27",
     DeepSkyObjectKind::PlanetaryNebula,
     19.99343889,
     22.72102778,
     7.400,
     6.7,
