...
constexpr std::array<BundledCatalogEntry, 9> kBundledCatalogEntries{{
    {"sun", "Sun", BaseCelestialBody::Kind::Sun, -26.74},
    {"moon", "Moon", BaseCelestialBody::Kind::Moon, -12.74},
    {"mercury", "Mercury", BaseCelestialBody::Kind::Planet, -1.90},
    {"venus", "Venus", BaseCelestialBody::Kind::Planet, -4.92},
    {"mars", "Mars", BaseCelestialBody::Kind::Planet, -2.94},
    {"jupiter", "Jupiter", BaseCelestialBody::Kind::Planet, -2.94},
    {"saturn", "Saturn", BaseCelestialBody::Kind::Planet, -0.55},
    {"uranus", "Uranus", BaseCelestialBody::Kind::Planet, 5.68},
    {"neptune", "Neptune", BaseCelestialBody::Kind::Planet, 7.78},
}};
...
constexpr std::array<BundledDeepSkyObjectEntry, 110> kBundledMessierEntries{{
    ...
    {"messier_002",
     "M2",
     DeepSkyObjectInfo::Kind::GlobularCluster,
     21.55750278,
     -0.82330556,
     6.250,
     8.4,
    ...
    {"messier_006",
     "M6",
     DeepSkyObjectInfo::Kind::OpenCluster,
     17.67243056,
     -32.25416667,
     4.200,
     15.6,
    ...
    {"messier_008",
     ...
     30,
     0.0,
     "M8|NGC 6523|NGC 6533|Lagoon Nebula"},
    {"messier_009",
     "M9",
     DeepSkyObjectInfo::Kind::GlobularCluster,
     17.31993889,
    ...
    {"messier_011",
     ...
     0.0,
     0.0,
     "M11|NGC 6705|Amas de l'Ecu de Sobieski|Wild Duck Cluster"},
    {"messier_012",
     "M12",
     DeepSkyObjectInfo::Kind::GlobularCluster,
     16.78736667,
    ...
    {"messier_017",
     ...
     0.0,
     0.0,
     "M17|NGC 6618|Checkmark Nebula|Lobster Nebula|Swan Nebula|omega Nebula"},
    {"messier_018",
     "M18",
     DeepSkyObjectInfo::Kind::OpenCluster,
     18.33291389,
    ...
    {"messier_024",
     "M24",
     DeepSkyObjectInfo::Kind::Asterism,
     18.28225556,
     -18.51455556,
     4.500,
     120,
     60,
     90,
     "M24|IC 4715|Small Sgr Star Cloud"},
    {"messier_025",
     "M25",
     DeepSkyObjectInfo::Kind::OpenCluster,
     18.52965833,
    ...
    {"messier_027",
     "M27",
     DeepSkyObjectInfo::Kind::PlanetaryNebula,
     19.99343889,
     22.72102778,
     7.400,
     6.7,
    ...
    {"messier_033",
     ...
     36.73,
     23,
     "M33|NGC 598|Triangulum Galaxy|Triangulum Pinwheel"},
    {"messier_034",
     "M34",
     DeepSkyObjectInfo::Kind::OpenCluster,
     2.70205556,
    ...
    {"messier_039",
     ...
     0.0,
     "M39|NGC 7092"},
    {"messier_040", "M40", DeepSkyObjectInfo::Kind::Unknown, 12.37113889, 58.08444444, 8.000, 0.0, 0.0, 0.0, "M40"},
    {"messier_041",
     "M41",
     DeepSkyObjectInfo::Kind::OpenCluster,
     6.76665000,
    ...
    {"messier_042",
     ...
     60,
     0.0,
     "M42|NGC 1976|Great Orion Nebula|Orion Nebula"},
    {"messier_043",
     "M43",
     DeepSkyObjectInfo::Kind::Nebula,
     5.59205000,
    ...
    {"messier_044",
     ...
     0.0,
     0.0,
     "M44|NGC 2632|Beehive|Praesepe Cluster"},
    {"messier_045",
     "M45",
     DeepSkyObjectInfo::Kind::OpenCluster,
     3.79127778,
    ...
    {"messier_064",
     ...
     5.33,
     114,
     "M64|NGC 4826|Black Eye Galaxy|Evil Eye Galaxy"},
    {"messier_065",
     "M65",
     DeepSkyObjectInfo::Kind::Galaxy,
     11.31553333,
    ...
    {"messier_073",
     "M73",
     DeepSkyObjectInfo::Kind::Unknown,
     20.98221389,
     -12.63550000,
     8.900,
     0.0,
    ...
    {"messier_076",
     ...
     0.0,
     0.0,
     "M76|NGC 650|NGC 651|Barbell Nebula|Cork Nebula|Little Dumbbell Nebula"},
    {"messier_077",
     "M77",
     DeepSkyObjectInfo::Kind::Galaxy,
     2.71130833,
    ...
    {"messier_099",
     ...
     4.74,
     23,
     "M99|NGC 4254|Coma Pinwheel|Virgo Cluster Pinwheel"},
    {"messier_100",
     "M100",
     DeepSkyObjectInfo::Kind::Galaxy,
     12.38189722,
...
std::vector<std::string> splitAliases(std::string_view aliases)
{
    ...
    while (cursor <= aliases.size()) {
        ...
        const std::size_t tokenEnd = delimiter == std::string_view::npos ? aliases.size() : delimiter;
...
BundledCatalogParser::parse(const std::string_view data, const CatalogParseProgressCallback& progressCallback) const
{
    ...
    result.distantBodies.reserve(kBundledMessierEntries.size());
    result.orderedBodyIndexes.reserve(kBundledCatalogEntries.size() + kBundledMessierEntries.size());
    ...
    for (const auto& entry : kBundledMessierEntries) {
        ...
        result.distantBodies.push_back(std::move(body));
    }
