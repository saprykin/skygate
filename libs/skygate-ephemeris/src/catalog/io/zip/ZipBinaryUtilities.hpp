...
class ZipBinaryUtilities final {
public:
    ZipBinaryUtilities() = delete;

    [[nodiscard]] static inline std::optional<std::uint16_t>
    readLe16(const std::string_view data, const std::size_t offset)
    {
    ...
    [[nodiscard]] static inline std::optional<std::uint32_t>
    readLe32(const std::string_view data, const std::size_t offset)
    {
